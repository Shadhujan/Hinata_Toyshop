...
<head>
    <meta charset="UTF-8">
    <title> Search - HinataToyshop</title>
    <link rel="stylesheet" href="CSS/Search - HinataToyshop.css">
...
<body>
	...
	<form action="Search - HinataToyshop.php" method="post">
	...
	<div>
		<!--<a id="Checkout" align="center">Search</a>-->
			...
			<?php
				//header('location:Search - HinataToyshop.php');
...
<script>
	$(document).ready(function(){
		var TitleRow =  "'<div id='ProductTable'><h1 id='Search'> From Search </h1><div id='OuterConentRow'><div id='box'><a href='ProductPage - HinataToyshop.php?ProductID=101'><img src='Images/11 Sandwich Bread-Sliced.jpeg'><div id='ProductDetails'><h3>Sandwich Bread-Sliced</h3><h2>LKR 500.00</h2></div></a></div>'";
		...
		$('#SSearchID').keyup(function(){
			...
			$.getJSON('BBDB.json', function(data) {
				$.each(data, function(key, value){
					...
					{
						$('#Results').append('<div id="box"><a href="ProductPage - HinataToyshop.php?ProductID='+value.ProductID+'"><img src="'+value.ProdImg+'"><div id="ProductDetails"><h3>'+value.ProductName+'</h3><h2>LKR '+value.Price+'</h2></div></a></div></div></div>');
					}
				});
			});
