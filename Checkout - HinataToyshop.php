<?php session_start();
	...
	$con = mysqli_connect("sdb-60.hosting.stackcp.net","HinataToyshop","HinataToyshop33","HinataToyshopDB-3530323533e4");
...
<head>
	<meta charset="utf-8">
    <title> Checkout - HinataToyshop</title>
    <link rel="stylesheet" href="CSS/Checkout - HinataToyshop.css">
...
<body>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a id="Order" href="Cart - HinataToyshop.php?CartID=<?php echo $_GET["CartID"];?>"><b>Back</b></a>
	...
	<div id="ProductTable">
		...
		$Total = 0.00;
			...
			//echo '<div id="box">';
				echo '<a href="ProductPage - HinataToyshop.php?ProductID='.$row2["ProductID"].'">';
					...
					echo '---------------------------------------------------------------------------------';
						//echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="DeleteFromCart - HinataToyshop.php?CartID='.$row1["CartID"].'" id="Order" align="center">Delete</a>';
					echo '</div>';
				echo '</a>';
			//echo '</div>';
			}
		...
		echo '<div align="right"><a href="AddToHistory - HinataToyshop.php?CartC='.$CartC.'" id="Checkout" align="center">Order</a></div>';
