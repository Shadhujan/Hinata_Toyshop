...
<head>
    <meta charset="UTF-8">
    <title> Content - HinataToyshop</title>
    <link rel="stylesheet" href="CSS/Content - HinataToyshop.css">
	...
	if(isset($_SESSION["Username"]))
	{
		...
		if($rowAdmin["Type"]=="Admin")
		{
			echo "<div align='center'>";
				echo '<br><br><a href="Add ProductPage - HinataToyshop.php" id="Order" align="center"><b>Add New Product</b></a><br>';
			echo "</div>";
		}
	}
		...
		elseif($rowP["ProdCategory"]==601){
			...
			echo '<div id="box">';
				if(isset($_SESSION["Username"]))
				{
					...
					{
						echo '<a id="'.$rowP["ProductID"].'" href="ProductPage - HinataToyshop.php?ProductID='.$rowP["ProductID"].'">';
					}
				}
				elseif($rowP["Availability"]==1)
				{
					...
					echo '<div id="ProductDetails">';
						...
						if(isset($_SESSION["Username"]))
						{
							...
							if($rowAdmin["Type"]=="Admin")
							{
								echo '<a href="Edit ProductPage - HinataToyshop.php?ProductID='.$rowP["ProductID"].'" id="Order" align="center"><b>Edit</b></a><br>';
								echo '<a href="DeleteProduct - HinataToyshop.php?ProductID='.$rowP["ProductID"].'" id="Order" align="center"><b>Delete</b></a>';
								echo '<form action="Content - HinataToyshop.php#'.$rowP["ProductID"].'" method="post">';
