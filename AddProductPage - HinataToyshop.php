...
<head>
	<meta charset="UTF-8">
    <title>Add ProductPage - HinataToyshop</title>
    <link rel="stylesheet" href="CSS/Add ProductPage - HinataToyshop.css">
			...
			<div id="box">
				<br><br>
					<div id="ProductDetails">
						...
						<form action="AddProduct - HinataToyshop.php" method="post">
